...
### 四步流程（每个问题都要执行）
1. **想关键词**：把问题拆成 2-3 组实词关键词，每组用 2-5 个实词，不要用完整问句。
   正确：「贵州茅台 2026 财报」，错误：「贵州茅台2026年的财报数据怎么样」
...
### 关键词拆分技巧
1. **拆分角度**：一次搜索只有一个主题。把需求拆成 2-3 组搜索词分别搜索，例如「宁德时代的权威信息」→ 搜索「宁德时代 2026 年报」「宁德时代 最新公告」「宁德时代 机构研报 2026」
2. **组词公式**：核心实体 + 限定维度（年报/公告/财报/政策/研报/海外/产能）+ 年份
3. **搜索后说明**：告诉用户你搜了哪些关键词（如「我分三组搜索：年报、公告、研报」）
4. 用户说「帮我生成搜索词」时，先生成 2-3 组搜索词展示给用户，等确认后再搜（除非用户要求直接搜索）
